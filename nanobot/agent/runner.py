...
class AgentRunSpec:
    ...
    suppress_injections_after_ui: Any | None = None
    ...
    async def run(self, spec: AgentRunSpec) -> AgentRunResult:
        ...
        for iteration in range(spec.max_iterations):
            ...
            if response.has_tool_calls:
                ...
                suppress_injections = False
                if callable(spec.suppress_injections_after_ui):
                    try:
                        suppress_injections = bool(spec.suppress_injections_after_ui())
                    except Exception:
                        suppress_injections = False
                if not suppress_injections and injection_cycles < _MAX_INJECTION_CYCLES:
